...
// INGRESA A TABLA VENTA
    public function ingresar_gestion_pago($cliente_id,$usuario_id,$gestion_id,$medio_pago,$bono){
      ...
      $query = $this->conexion->prepare("INSERT INTO venta (cliente_id,usuario_id, gestion_id,medio_pago,fecha_creacion,activo,estado,codigo_venta,bono) VALUES (:cliente_id,:usuario_id,:gestion_id,:medio_pago,NOW(),1,1,:codigo_venta,:bono)");
      $query->execute(array(':cliente_id'=>$cliente_id,
        ...
        foreach ($ventas_items_examenes as $datos_venta_examenes) {
          //INGRESAR ITEMS DE VENTA
          $this->ingresar_venta_items($datos_venta_examenes["examen_id"],
            $cliente_id,
            $gestion_id,
