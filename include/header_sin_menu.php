    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <?php echo  $_SESSION['NOMBRE_USUARIO']; ?> 
          ...
          <ul class="dropdown-menu" style="background: #214761;">
            ...
            <li><a onclick="window.close()" style="color:white; font-style: bold">  <img src="../web/images/boton-de-encendido.png" alt="" alt="Cerrar sesion" title="Cerrar session"/> Cerrar Ventana
            </a></li>
          </ul>
        </li>
      </ul>
