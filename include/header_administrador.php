    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            if ($_SESSION['PERMISOS'] == 10) {
                $inicio = "../web/perfil_toma.php";
            } else if ($_SESSION['PERMISOS'] == 11 || $_SESSION['PERMISOS'] == 1 || $_SESSION['PERMISOS'] == 2) {
                $inicio = "../web/inicio_usuario.php";
            } else if ($_SESSION['PERMISOS'] == 6) {
                $inicio = "../web/inicio_digiturno.php";
            } else if ($_SESSION['PERMISOS'] == 9) {
                $inicio = "../web/perfil_pago_turno.php";
            } else if ($_SESSION['PERMISOS'] == 12) {
                $inicio = "../web/inicio_doc.php";
            } else if ($_SESSION['PERMISOS'] == 5) {
                $inicio = "../web/inicio_administrador.php";
            } else if ($_SESSION['PERMISOS'] == 7) {
                $inicio = "../web/inicio_admin_digiturno.php";
            }
            ?>
            ...
            <ul class="nav navbar-nav navbar-right" >
                ...
                <li class="dropdown" >
                    ...
                    <ul class="dropdown-menu" style="background-color: #214761;">
                        <?php if ($_SESSION['PERMISOS'] == 1 || $_SESSION['PERMISOS'] == 2 || $_SESSION['PERMISOS'] == 6 || $_SESSION['PERMISOS'] == 11) { ?>
