        ...
        <div class="container" style="height:auto;">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="inicio_admin_digiturno.php" title="Volver atras"><img src="images/atras.png"></a></li>
                        <li><a href="inicio_admin_digiturno.php" title="Inicio">Inicio</a></li>
                        <li class="active">Administrar permisos de asesores</li>
                    </ol>
                    ...
                    <div class="row pad-top" style="background-color: white;">
                        <div id="home"  style="padding: 20px;">
                            ...
                            <div align="right">
                            <a href="agregar_usuario_digiturno.php">
                                        ...
                                        <table id="data-table-basic" class="table table-bordered">
                                            <thead>
                                                <tr style="background-color: #214761;">
                                                    ...
                                                    <th style="color:white">Cambio Area</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $listar_usuarios_digiturno = $usuario->listar_usuarios_digiturno();
                                                foreach ($listar_usuarios_digiturno as $datos){?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $datos["descripcion_permiso"] ?></td>
                                                    <td style="text-align: center">
                                                       
                                                        <?php $activo = $datos["permisos_digiturno"];
                                                        if($activo== 1){ ?>
                                                        <button class="estado_usuario_digiturno" data-id="<?php echo $datos["id"];?>" data-estado='<?php echo $datos["permisos_digiturno"] ?>' style="background-color: transparent;border: none;">
