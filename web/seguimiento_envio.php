                                    ...
                                    <div id="div_usuarios" style="display: none;padding: 5px;">   
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body" >
                                                ...
                                                <form enctype="multipart/form-data" class="formulario" id="formuploadajax">
                                                    <input type="hidden" name="tipo" id="tipo" value="222">
                                                    <input type="hidden" id="cliente_seleccionado" name="cliente_seleccionado">   
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    
                                                          <div class="rtf-box" style="width: 100%; height: 200px; overflow: auto;">
                                                            <div class="rtf-tools">
                                                              <b>&nbsp;&nbsp;Cuerpo de Correo</b>
                                                            </div>
                                                            <div class="rtf-text" contenteditable="true">
Buenos dias.<br>Nos comunicamos de parte de NOMBRE

                                             <div id="file-preview-zone" style="width: 500px;">
                                             </div>
 
                                                            </div>
                                                            <textarea hidden="hidden" id="textarea" name="textarea"></textarea>
                                                          </div>
                                            <div id="divInputLoad">
                                             <div id="divFileUpload">
        Seleccione el archivo para adjuntar : <input id="adjuntos_doc" type="file"  />
                             Agregar imagen : <input id="file-upload" type="file" accept="image/*"/>
                                             <input id="cancelar" type="button" value="Eliminar fotos" class="btn btn-danger" onClick="eliminar()"></input>
                                             <br>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><br>
                                                        <img src="images/email_correo.png"> 
                                                        <input type="submit" class="btn btn-primary" id="btn_envio_masivo" value="Envio de Correo" readonly="true" > 
                                                    </div>
                                                </form>
