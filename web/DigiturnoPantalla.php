...
<script src="../web/js/data-table/jquery.dataTables.min.js"></script>
<script src="../web/js/data-table/data-table-act.js"></script>
...
<body style="background-color: #F6F8FA">
    ...
    <center><img src="images/footerdigi.png" height="672" width="1171"></center>
    <script>
        setInterval(TurnosModulos, 1000);
    </script>
</body>
