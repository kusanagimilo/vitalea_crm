                            ...
                            <div class="panel-body">
                                <div class="cta-desc">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control"  id="numero_documento" value="<?php echo $documento; ?>"  readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            <label>Nombres</label>
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control"  id="nombre" value="<?php echo $nombre_cliente ?>"  readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control" id="apellido" value="<?php echo $apellido_cliente ?>"  readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nk-int-st">
                                                <input type="date" class="form-control"  id="fecha_nacimiento" value="<?php echo $fecha_nacimiento; ?>" readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nk-int-st">
                                                <input name="telefono_uno" id="telefono_uno" class="form-control" type="text" value="<?php echo $telefono_1; ?>"  readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nk-int-st">
                                                <input name="telefono_dos" id="telefono_dos" class="form-control" type="text" value="<?php echo $telefono_2 ?>"  readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="nk-int-st">
                                                <input name="email" id="email" class="form-control" type="text" value="<?php echo $email ?>"  readonly="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="nk-int-st">
                                            <input name="sexo" id="sexo" class="form-control" type="text" value="<?php echo $sexo ?>"  readonly="true">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="nk-int-st">
                                            <input name="estado_civil" id="estado_civil" class="form-control" type="text" value="<?php echo $estado_civil ?>"  readonly="true">
                                        </div>
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="cta-desc">
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <label>Barrio</label>
                                        <div class="nk-int-st">
                                            <input name="barrio" id="barrio" class="form-control" type="text" value="<?php echo $barrio ?>" readonly="true">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    <div class="form-group">
                                        <label>Estrato</label>
                                        <div class="nk-int-st">
                                            <input name="estrato" id="estrato" class="form-control" type="text" value="<?php echo $estrato ?>" readonly="true">
                                        </div>
                                    </div>
                                </div>
                            </div>
