        ...
        <div class="container" style="height:auto;">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="administrar_asesores.php" title="Volver atras"><img src="images/atras.png"></a></li>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <table id="data-table-basic" class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $habilitar_usuarios_digiturno = $usuario->habilitar_usuarios_digiturno();
                                                foreach ($habilitar_usuarios_digiturno as $datos){?>
                                                <tr>
