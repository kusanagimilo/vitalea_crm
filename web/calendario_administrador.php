...
$listar_seguimientos = $seguimiento->calendario_admin();
?>
		...
		$('#calendar').fullCalendar({
			  ...
			  events: [
				    <?php foreach ($listar_seguimientos as $datos) { 
				    	if($datos["activo"]==1){ //inicial
				    		$color ="blue";
				    		$estado = "Inicial";
				    	}else if($datos["activo"]==2){ // pendientes
				    		$color ="red";
				    		$estado ="Pendiente";
				    	}
				     ?>	
	                    {
	                        title: '<?php echo $datos["conteo"] ?> - <?php echo $datos["usuario_id"] ?>' ,
	                        start: '<?php echo $datos["fecha_programada"] ?>',
	                        end: '<?php echo $datos["fecha_programada"] ?>',
	                        description: 'Estado: <?php echo $estado ?>',
                        ...
                        <div class="panel-heading " style="height: 50px;">
                            <h3 class="panel-title"> 
                            	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                            		<b  style="float: left">  <img src="images/fecha.png" alt=""/> Número Seguimientos activos que han sido programados para volver a llamar</b>
                            	</div>
                            	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="text-align: right;">
                            		<a href="seguimientos_programados_admin.php" class="btn btn-default"> <img src="images/mas.png" alt=""/> Ver todos </a>
                            	</div>
