                            ...
                            <div id="examenes" style="padding: 20px;" >
								<div id="mainbody">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										...
										<img src="images/cargando.gif" style="width: 25px;" />
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="display: none">
                                      ...
                                      <img src="images/info.png" alt=""/>Resultado Exitoso</p>
                                      <center>
									<canvas id="qr-canvas" class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="width: 100%;border: 1px solid;"></canvas>
									</center>
									</div>
