...
WHERE ven.id =:id");
        ...
        $headers = new SoapHeader("http://tempuri.org/", 'ServiceAuthHeader', new WSAPI("AtheneaWS", "4th3n3a*"));
        ...
        $xml_ingresar_paciente = "<ROOT>
 		<SOLICITUD NUEVO='1' USUARIOGENERO='1' IDENTIFICADOR='' TIPOHOMOLOGACION=''>
 		<PACIENTE>
...
WHERE ven.id =:id");
        ...
        $xml = '<ROOT>
                <SOLICITUD NUEVO="1" USUARIOGENERO="SOPORTE" IDENTIFICADOR="" TIPOHOMOLOGACION="">
                <PACIENTE>
                   <TIPOIDENTIFICACION>' . $tipo_documento . '</TIPOIDENTIFICACION>
                    <NUMEROIDENTIFICACION>' . $arreglo[0]['documento'] . '</NUMEROIDENTIFICACION>
                </PACIENTE>
